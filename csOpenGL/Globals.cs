...
namespace LD46
{
    public static class Globals
    {
        ...
        public static List<Spell> Spells = new List<Spell> { new Fireball(), new PillarOfLight(), new Slowness(), new Shield(), new RayOfFrost(), new Disable(), new Banishment(), new Surge() };
